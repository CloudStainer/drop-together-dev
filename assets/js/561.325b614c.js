  ...
  [561],
  {
    6322: (e, t, n) => {
      ...
      var i = n(5485),
        r = n.n(i),
        s = n(7533);
      s.Z.tokenizer.separator = /[\s\-/]+/;
      const o = class {
        constructor(e, t, n, i) {
          void 0 === n && (n = "/"),
            (this.searchDocs = e),
            (this.lunrIndex = s.Z.Index.load(t)),
            (this.baseUrl = n),
            (this.maxHits = i);
        }
        getLunrResult(e) {
          return this.lunrIndex.query(function (t) {
            const n = s.Z.tokenizer(e);
            t.term(n, { boost: 10 }),
              t.term(n, { wildcard: s.Z.Query.wildcard.TRAILING });
          });
        }
        getHit(e, t, n) {
          return {
            hierarchy: {
              lvl0: e.pageTitle || e.title,
              lvl1: 0 === e.type ? null : e.title,
            },
            url: e.url,
            version: e.version,
            _snippetResult: n
              ? { content: { value: n, matchLevel: "full" } }
              : null,
            _highlightResult: {
              hierarchy: {
                ...
                for (let s in i)
                  if (i[s].title) {
                    if (!this.titleHitsRes.includes(t.ref)) {
                      ...
                      r.push(this.getTitleHit(n, o, e.length)),
                        this.titleHitsRes.push(t.ref);
                    }
                  } else if (i[s].content) {
                    ...
                    r.push(this.getKeywordHit(n, o, e.length)),
                      this.titleHitsRes.push(t.ref);
                  }
              }),
      ...
      class g {
        constructor(e) {
          ...
          (this.input = g.getInputFromSelector(i)),
            (this.queryDataCallback = a || null);
          ...
          (this.autocompleteOptions.ariaLabel =
            this.autocompleteOptions.ariaLabel || b || "search input"),
        ...
        static bindSearchBoxEvent() {
          d()('.searchbox [type="reset"]').on("click", function () {
            d()("input#docsearch").focus(),
              d()(this).addClass("hide"),
              u().autocomplete.setVal("");
          }),
            d()("input#docsearch").on("keyup", () => {
              ...
              (t.className = "searchbox__reset"),
                0 === e.value.length && (t.className += " hide");
            });
        }
        ...
        static formatHits(e) {
          const t = f
            ...
            .map(
              (e) => (
                e._highlightResult &&
                  (e._highlightResult = f.mergeKeyWithParent(
                    e._highlightResult,
                    "hierarchy"
                  )),
        ...
        static formatURL(e) {
          ...
          return n
            ? `#${e.anchor}`
            : (console.warn("no anchor nor url for : ", JSON.stringify(e)),
              null);
        }
      ...
      function h(e) {
        ...
        ((e = e || {}).templates = e.templates || {}),
          ...
          e.name &&
            ...
            o.error("invalid dataset name: " + e.name),
          (this.query = null),
          (this._isEmpty = !0),
          (this.highlight = !!e.highlight),
          (this.name =
            void 0 === e.name || null === e.name ? o.getUniqueId() : e.name),
          ...
          (this.cssClasses = e.cssClasses =
            o.mixin({}, c.defaultClasses, e.cssClasses || {})),
          ...
          _render: function (e, t) {
            ...
            function h() {
              ...
              return (
                ...
                c.templates.header.apply(this, t)
              );
            }
            function p() {
              var t = [].slice.call(arguments, 0);
              return (
                (t = [{ query: e, isEmpty: !n }].concat(t)),
                c.templates.footer.apply(this, t)
              );
            }
          },
          getRoot: function () {
    ...
    5445: (e, t, n) => {
      ...
      function u(e) {
        ...
        (e = e || {}).menu || i.error("menu is required"),
          i.isArray(e.datasets) ||
            i.isObject(e.datasets) ||
          ...
          (this.cssClasses = e.cssClasses =
            i.mixin({}, a.defaultClasses, e.cssClasses || {})),
          (this.cssClasses.prefix =
            e.cssClasses.formattedPrefix ||
        ...
        (this.$menu = r
          ...
          i.each(this.datasets, function (e) {
            var t = e.getRoot();
            t && 0 === t.parent().length && o.$menu.append(t),
      ...
      i.mixin(u.prototype, s, {
        ...
        _onRendered: function (e, t) {
          if (
            ...
            if (
              (t.length >= this.minLength && this.trigger("empty"), this.$empty)
            )
    ...
    7368: (e, t, n) => {
      ...
      var i = n(5670),
        r = n(3855);
      function s(e) {
        (e && e.el) || i.error("EventBus initialized without el"),
          (this.$el = r.element(e.el));
      }
      i.mixin(s.prototype, {
    ...
    6823: (e, t, n) => {
      ...
      function o(e, t, n) {
        return function () {
          for (var i, r = 0, s = e.length; !i && r < s; r += 1)
            i = !1 === e[r].apply(t, n);
          return !i;
        };
      }
      e.exports = {
        ...
        trigger: function (e) {
          ...
          for (; (t = e.shift()) && (n = this._callbacks[t]); )
            (a = o(n.sync, this, [t].concat(s))),
              (u = o(n.async, this, [t].concat(s))),
              a() && i(u);
          return this;
        },
      };
        ...
        r.mixin(a.prototype, o, {
          ...
          _checkInputValue: function () {
            ...
            (e = this.getInputValue()),
              ...
              (n =
                !(
                  !(t = a.normalizeQuery(i) === a.normalizeQuery(r)) ||
                  !this.query
    ...
    4520: (e, t, n) => {
      ...
      function h(e) {
        ...
        (this.css = e.css = r.mixin({}, l, e.appendTo ? l.appendTo : {})),
          (this.cssClasses = e.cssClasses =
            r.mixin({}, l.defaultClasses, e.cssClasses || {})),
        ...
        var a = (function (e) {
          ...
          (t = s.element(e.input)),
            (n = s
              .element(c.wrapper.replace("%ROOT%", e.cssClasses.root))
              .css(e.css.wrapper)),
            e.appendTo ||
              "block" !== t.css("display") ||
          ...
          (o = s
            ...
            e.templates &&
              ...
              o.html(r.templatify(e.templates.dropdownMenu)());
          (a = t
            .clone()
            .css(e.css.hint)
            .css(
          ...
          t.data(i, {
            ...
            t
              .addClass(
                r.className(e.cssClasses.prefix, e.cssClasses.input, !0)
              )
              .attr({
                autocomplete: "off",
                spellcheck: !1,
          ...
          return (
            (n = e.appendTo
              ? n.appendTo(s.element(e.appendTo).eq(0)).eq(0)
              : t.wrap(n).parent()),
      ...
      e.exports = {
        ...
        escapeHighlightedString: function (e, t, n) {
          ...
          return (
            ...
            o.innerHTML
              .replace(RegExp(s(i.innerHTML), "g"), t)
      ...
      e.exports = function (e, t) {
        ...
        return (
          n &&
            n[0] >= 3 &&
            n[1] > 20 &&
            ((t = t || {}).additionalUA = "autocomplete.js " + r),
          function (n, r) {
    ...
    6331: (e, t, n) => {
      "use strict";
      e.exports = { hits: n(2683), popularIn: n(2226) };
    },
    2226: (e, t, n) => {
      "use strict";
      var i = n(5670),
        ...
        (e.exports = (function (e) {
          var t,
            ...
            i = (function () {
              ...
              function F(e) {
                return (
                  D(e) && !R(e) && Object.getPrototypeOf(e) == Object.prototype
                );
              }
              function j(e) {
              ...
              return (
                ...
                (O.init = function (e, n) {
                  ...
                  if ("string" == typeof e)
                    ...
                    if (P(e)) r = H(e);
                      ...
                      (r = O.fragment(e.trim(), RegExp.$1, n)), (e = null);
                    else {
                      if (n !== t) return i(n).find(e);
                      r = O.qsa(h, e);
                    }
                ...
                (i.each = function (e, t) {
                  ...
                  if (j(e)) {
                    ...
                    for (i in e) if (!1 === t.call(e[i], i, e[i])) return e;
                  return e;
                }),
                (i.grep = function (e, t) {
                  return c.call(e, t);
                ...
                (i.fn = {
                  ...
                  closest: function (e, t) {
                    ...
                    return (
                      this.each(function (i, s) {
                        for (
                          ;
                          s && !(r ? r.indexOf(s) >= 0 : O.matches(s, e));
                  ...
                  wrap: function (e) {
                    ...
                    return this.each(function (s) {
                      i(this).wrapAll(
                        t ? e.call(this, s) : r ? n.cloneNode(!0) : n
                      );
                    });
                  },
                  wrapAll: function (e) {
                  ...
                  html: function (e) {
                    return 0 in arguments
                      ? this.each(function (t) {
                          ...
                          i(this).empty().append(G(this, e, t, n));
                        })
                      : 0 in this
                      ? this[0].innerHTML
                      : null;
                      ...
                      ? this.each(function (t) {
                          if (1 === this.nodeType)
                            if (D(e)) for (n in e) J(this, n, e[n]);
                              ...
                              J(this, e, G(this, i, t, this.getAttribute(e)));
                        })
                      : 0 in this &&
                        1 == this[0].nodeType &&
                  ...
                  position: function () {
                    if (this.length) {
                      ...
                      return (
                        ...
                        (r.top +=
                          parseFloat(i(t[0]).css("border-top-width")) || 0),
                        (r.left +=
                          parseFloat(i(t[0]).css("border-left-width")) || 0),
                ...
                w.forEach(function (n, r) {
                  ...
                  (i.fn[n] = function () {
                    ...
                    (i.fn[s ? n + "To" : "insert" + (r ? "Before" : "After")] =
                      function (e) {
            ...
            (function (t) {
                ...
                i.split(/\s/).forEach(function (i) {
                  ...
                  (a.proxy = function (t) {
                    if (!(t = E(t)).isImmediatePropagationStopped()) {
                      ...
                      return (
                        !1 === r && (t.preventDefault(), t.stopPropagation()), r
                      );
                    }
                  }),
                    (a.i = d.length),
                    ...
                    "addEventListener" in e &&
                      e.addEventListener(y(a.e), a.proxy, m(a, c));
                });
              }
              ...
              (u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents"),
                ...
                (t.proxy = function (e, n) {
                  ...
                  if (o(n))
                    return i
                      ? (i.unshift(e[n], e), t.proxy.apply(null, i))
                      : t.proxy(e[n], e);
              ...
              (t.fn.delegate = function (e, t, n) {
                ...
                (t.fn.trigger = function (e, n) {
                  return (
                    ((e =
                      o(e) || t.isPlainObject(e) ? t.Event(e) : E(e))._args =
                      n),
                    this.each(function () {
                ...
                return (
                  e.each(t.attributes || s, function (t, r) {
                    0 == r.name.indexOf("data-") &&
                      (n[i(r.name.replace("data-", ""))] =
                        e.zepto.deserializeValue(r.value));
                  }),
                  n
                );
              }
      ...
      !(function (e) {
        ...
        function p(t, n, i, r) {
          ...
          for (s = i[i.length - 1]; t.length > 0; ) {
            ...
            if (e.tags[u.tag] <= e.tags.$ || d(u, r))
              i.push(u), (u.nodes = p(t, u.tag, i, r));
            else {
              if ("/" == u.tag) {
                if (0 === i.length)
        ...
        function g(e) {
          ...
          return (
            ...
            (function (e) {
              var t = [];
              for (var n in e)
                t.push('"' + y(n) + '": function(c,p,t,i) {' + e[n] + "}");
              return "{ " + t.join(",") + " }";
            })(e.subs)
          );
        }
          ...
          (e.Template.prototype = {
            ...
            ep: function (e, t) {
              ...
              if (((this.partials[e].base = i), n.subs)) {
                ...
                i = (function (e, t, n, i, r, s) {
                  ...
                  for (u in ((r = r || {}), (c.stackPartials = r), n))
                    r[u] || (r[u] = n[u]);
            ...
            d: function (e, n, i, r) {
              ...
              return (
                ...
                (r ||
                  "function" != typeof a ||
                  (n.push(l), (a = this.mv(a, n, i)), n.pop()),
                a)
              );
            },
            f: function (e, n, i, r) {
    ...
    624: (e, t, n) => {
      ...
      function l() {
        i &&
          r &&
          ((i = !1), r.length ? (u = r.concat(u)) : (a = -1), u.length && h());
      }
      function h() {
        if (!i) {
          (c = !1), (i = !0);
      ...
      !(function () {
        ...
        (R.version = "2.3.9"),
          ...
          (R.utils.clone = function (e) {
            if (null == e) return e;
            for (
              var t = Object.create(null), n = Object.keys(e), i = 0;
              i < n.length;
              i++
            ) {
              var r = n[i],
          ...
          (R.FieldRef.prototype.toString = function () {
            return (
              null == this._stringValue &&
                (this._stringValue =
                  this.fieldName + R.FieldRef.joiner + this.docRef),
              this._stringValue
            );
          }),
          (R.Set = function (e) {
          ...
          (R.tokenizer = function (e, t) {
            ...
            if (Array.isArray(e))
              return e.map(function (e) {
                return new R.Token(
                  R.utils.asString(e).toLowerCase(),
                  R.utils.clone(t)
                );
              });
            for (
              ...
              if (n.charAt(s).match(R.tokenizer.separator) || s == i) {
                if (a > 0) {
                  ...
                  (u.position = [o, a]),
                    (u.index = r.length),
                    r.push(new R.Token(n.slice(o, s), u));
                }
                o = s + 1;
              }
            }
          ...
          (R.Pipeline.registerFunction = function (e, t) {
            t in this.registeredFunctions &&
              R.utils.warn("Overwriting existing registered function: " + t),
              (e.label = t),
          ...
          (R.TokenSet = function () {
            (this.final = !1),
              (this.edges = {}),
              (this.id = R.TokenSet._nextId),
              (R.TokenSet._nextId += 1);
          }),
          (R.TokenSet._nextId = 1),
          (R.TokenSet.fromArray = function (e) {
            for (
              var t = new R.TokenSet.Builder(), n = 0, i = e.length;
              n < i;
              n++
            )
              t.insert(e[n]);
          ...
          (R.TokenSet.fromFuzzyString = function (e, t) {
            for (
              var n = new R.TokenSet(),
                i = [{ node: n, editsRemaining: t, str: e }];
              i.length;
          ...
          (R.TokenSet.fromString = function (e) {
            for (
              var t = new R.TokenSet(), n = t, i = 0, r = e.length;
              i < r;
              i++
            ) {
              var s = e[i],
          ...
          (R.TokenSet.Builder.prototype.insert = function (e) {
            ...
            for (i = n; i < e.length; i++) {
              var r = new R.TokenSet(),
                s = e[i];
              (t.edges[s] = r),
                this.uncheckedNodes.push({ parent: t, char: s, child: r }),
                (t = r);
            }
          ...
          (R.Index.prototype.query = function (e) {
            ...
            for (a = 0; a < this.fields.length; a++) {
              var $;
              s[($ = this.fields[a])] && (O = O.intersect(s[$])),
                o[$] && (A = A.union(o[$]));
            }
            var P = Object.keys(n),
              I = [],
            ...
            for (a = 0; a < P.length; a++) {
              ...
              if (O.contains(D) && !A.contains(D)) {
                ...
                if (void 0 !== (F = Q[D]))
                  (F.score += H), F.matchData.combine(n[N]);
                else {
            ...
            for (var r = 0; r < i.length; r++) {
              ...
              for (var p = 0; p < c.length; p++) {
                ...
                if (
                  (null == h[d] && (h[d] = 0),
                  (h[d] += 1),
                  null == this.invertedIndex[d])
                ) {
                  var f = Object.create(null);
                  (f._index = this.termIndex), (this.termIndex += 1);
                  for (var g = 0; g < i.length; g++)
                    f[i[g]] = Object.create(null);
                ...
                for (var m = 0; m < this.metadataWhitelist.length; m++) {
                  var y = this.metadataWhitelist[m],
                    v = d.metadata[y];
                  null == this.invertedIndex[d][s][n][y] &&
                    (this.invertedIndex[d][s][n][y] = []),
          ...
          (R.Builder.prototype.createFieldVectors = function () {
            for (
              ...
              for (
                ...
                void 0 === i[v]
                  ? ((g = R.idf(this.invertedIndex[v], this.documentCount)),
                    (i[v] = g))
                  : (g = i[v]),
                  (m =
                    (g * ((this._k1 + 1) * x)) /
          ...
          (R.MatchData = function (e, t, n) {
            for (
              var i = Object.create(null), r = Object.keys(n || {}), s = 0;
              s < r.length;
              s++
            ) {
              var o = r[s];
              ...
              for (var s = 0; s < r.length; s++) {
                ...
                for (var u = 0; u < a.length; u++) {
                  ...
                  null == this.metadata[i][o][c]
                    ...
                    : (this.metadata[i][o][c] = this.metadata[i][o][c].concat(
                        e.metadata[i][o][c]
                      ));
                }
              }
          ...
          (R.Query.prototype.isNegated = function () {
            for (var e = 0; e < this.clauses.length; e++)
              if (this.clauses[e].presence != R.Query.presence.PROHIBITED)
                return !1;
            return !0;
          }),
          ...
          (R.QueryLexer.prototype.sliceString = function () {
            for (
              var e = [], t = this.start, n = this.pos, i = 0;
          ...
          (R.QueryLexer.lexField = function (e) {
            return (
              e.backup(),
              e.emit(R.QueryLexer.FIELD),
              e.ignore(),
              R.QueryLexer.lexText
            );
          }),
          (R.QueryLexer.lexTerm = function (e) {
            if (
              (e.width() > 1 && (e.backup(), e.emit(R.QueryLexer.TERM)),
              e.ignore(),
              e.more())
            )
          ...
          (R.QueryLexer.lexEditDistance = function (e) {
            return (
              e.ignore(),
              e.acceptDigitRun(),
              e.emit(R.QueryLexer.EDIT_DISTANCE),
              R.QueryLexer.lexText
            );
          }),
              ...
              if (92 != t.charCodeAt(0)) {
                ...
                if ("^" == t)
                  return (
                    e.backup(),
                    e.width() > 0 && e.emit(R.QueryLexer.TERM),
                    R.QueryLexer.lexBoost
                  );
                if ("+" == t && 1 === e.width())
                  return e.emit(R.QueryLexer.PRESENCE), R.QueryLexer.lexText;
                if ("-" == t && 1 === e.width())
                  return e.emit(R.QueryLexer.PRESENCE), R.QueryLexer.lexText;
                if (t.match(R.QueryLexer.termSeparator))
